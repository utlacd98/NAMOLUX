...
const RAW_LEXICONS: Record<IndustryOption, IndustryLexicon> = {
  ...
  "E-commerce": {
    roots: ["shop", "store", "cart", "market", "checkout", "retail", "merchant", "basket", "order", "catalogue", "route", "ship", "fleet", "stock", "dock"],
    verbs: ["sell", "list", "ship", "convert", "deliver", "bundle", "stock", "promote", "route", "fulfill"],
  ...
  "SaaS & Software": {
    roots: ["saas", "software", "app", "suite", "platform", "workflow", "dashboard", "portal", "automation", "module", "signal", "sync", "team", "calendar", "meeting", "task"],
  ...
  "Nonprofit & Social Impact": {
    roots: ["impact", "charity", "community", "mission", "cause", "outreach", "equity", "foundation", "giving", "advocacy", "support", "mind", "care", "haven", "teen", "safe"],
...
const LIGHTWEIGHT_THESAURUS: Record<string, string[]> = {
  ...
  logistics: ["route", "ship", "fleet", "dock", "stock", "order", "delivery"],
  shipping: ["route", "ship", "fleet", "dock", "load", "delivery"],
  delivery: ["route", "fleet", "ship", "flow", "dispatch"],
  renewable: ["energy", "solar", "green", "grid", "carbon", "climate"],
  energy: ["solar", "grid", "watt", "green", "renew", "climate"],
  climate: ["carbon", "green", "terra", "renew", "grid"],
  nonprofit: ["support", "community", "care", "mission", "haven", "safe"],
  mental: ["mind", "care", "support", "safe", "haven", "calm"],
  teenager: ["teen", "safe", "support", "care", "community"],
  teenagers: ["teen", "safe", "support", "care", "community"],
  scheduling: ["calendar", "meeting", "slot", "availability", "sync", "time"],
  schedule: ["calendar", "meeting", "slot", "availability", "sync", "time"],
  calendar: ["schedule", "meeting", "slot", "time", "sync"],
  meeting: ["calendar", "schedule", "sync", "team", "slot"],
  remote: ["team", "sync", "workflow", "async", "distributed"],
  teams: ["team", "sync", "workflow", "meeting", "collaboration"],
  team: ["sync", "workflow", "meeting", "collaboration"],
  bookkeeping: ["ledger", "invoice", "receipt", "books", "cashflow", "balance"],
  invoices: ["ledger", "receipt", "cashflow", "books"],
  receipts: ["ledger", "invoice", "cashflow", "books"],
  cashflow: ["ledger", "cash", "flow", "balance", "books"],
  privacy: ["vault", "shield", "secure", "private", "trust"],
