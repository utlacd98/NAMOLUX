    ...
    content: [
      {
        ...
        text: "Turning an idea into a brand used to take hours. You'd have to come up with a name, check if the domain is available, write a brand story, and figure out colours and identity. Now it takes seconds.",
      },
      {
        type: "paragraph" as const,
        text: "With NamoLux, you can go from a simple idea to a complete brand identity instantly. Here are 3 real examples showing what's possible.",
      },
      {
        type: "heading" as const,
        text: "The Old Process vs. The New Process",
      },
      {
        type: "paragraph" as const,
        text: "Before tools like NamoLux, a founder building a brand from scratch would spend days on tasks that should take minutes. Name brainstorming, domain hunting, brand voice, visual direction — each step was its own rabbit hole. Most founders would either rush it and regret it, or overthink it and never ship.",
      },
      {
        type: "paragraph" as const,
        text: "The new process: describe your idea, generate names with availability already checked, build a brand colour palette, and get a complete landing page prompt — all without leaving a single tool.",
      },
      {
        type: "heading" as const,
        text: "Example 1: Food & Lifestyle Brand — Joynest",
      },
      {
        type: "paragraph" as const,
        text: "The idea: a cosy lifestyle brand focused on happiness, comfort, and home living.",
      },
      {
        type: "paragraph" as const,
        text: "The process: enter the concept into NamoLux with a Playful vibe. The generator surfaces names grounded in emotion and warmth. Joynest comes through — immediately evocative, available on .com, scoring well on memorability and pronounceability.",
      },
      {
        type: "paragraph" as const,
        text: "From there: open the Brand Studio, enter Joynest, generate a colour palette. The AI returns soft amber, cream, and warm terracotta tones that match the brand personality without needing a single design decision. Copy the Stitch prompt and paste it into Google Stitch — a full landing page emerges with the exact colours, tone, and layout to match.",
      },
      {
        type: "paragraph" as const,
        text: "Generated using NamoLux",
      },
      {
        type: "paragraph" as const,
        text: "What stands out: Joynest instantly feels like a real brand. The name alone creates emotion — joy + nest — and the visual direction supports it naturally. No mood boards, no agency brief, no back-and-forth.",
      },
      {
        type: "heading" as const,
        text: "Example 2: Security & Trust Brand — Authway",
      },
      {
        type: "paragraph" as const,
        text: "The idea: a platform focused on identity security and access control.",
      },
      {
        type: "paragraph" as const,
        text: "The process: enter the concept with a Trustworthy vibe. NamoLux generates structured, confident names. Authway lands — clean, functional, and clearly communicates what the product does without jargon. The Founder Signal score is strong: short, pronounceable, low brand risk.",
      },
      {
        type: "paragraph" as const,
        text: "Colour palette: deep teal, slate, and clean off-white — professional without being cold. The Stitch prompt produces a landing page that feels like a real SaaS product from day one.",
      },
      {
        type: "paragraph" as const,
        text: "Generated using NamoLux",
      ...
      {
        type: "paragraph" as const,
        text: "What stands out: even for a technical, serious industry the branding feels distinct and clear. It doesn't look like every other security startup — it has a point of view. That's what a good brand name anchors.",
      },
      {
        type: "heading" as const,
        text: "Example 3: Luxury Brand — Finesh",
      },
      {
        type: "paragraph" as const,
        text: "The idea: a refined lifestyle or fashion brand focused on elegance and everyday luxury.",
      },
      {
        type: "paragraph" as const,
        text: "The process: Luxury vibe selected. NamoLux filters toward names with restraint — short, clean, no gimmicks. Finesh surfaces: minimal, slightly French in feel, open to interpretation across fashion, skincare, or interiors. The .com is available.",
      },
      {
        type: "paragraph" as const,
        text: "Colour palette: warm stone, deep charcoal, and gold — classic luxury territory done without cliché. The Stitch prompt generates an elegant serif-led landing page with generous spacing that looks like something a £1,000+ agency would produce.",
      },
      {
        type: "paragraph" as const,
        text: "Generated using NamoLux",
      ...
      {
        type: "paragraph" as const,
        text: "What stands out: the typography and spacing alone elevate it. This is what happens when the name, palette, and layout are all built around the same brief — they reinforce each other instead of fighting each other.",
      },
      {
        type: "heading" as const,
        text: "The Full Process — Step by Step",
      },
      {
        type: "paragraph" as const,
        text: "For anyone who wants to replicate this, here is the exact workflow:",
      },
      {
        type: "paragraph" as const,
        text: "Step 1 — Describe your idea. In NamoLux, type a short description of what your brand is and who it's for. Be specific: 'a cosy lifestyle brand for home living' produces better names than 'a lifestyle brand'.",
      },
      {
        type: "paragraph" as const,
        text: "Step 2 — Choose your vibe. Luxury, Futuristic, Playful, Trustworthy, or Minimal. This shapes both the name generation and the colour palette. Pick the one that matches how you want your brand to feel.",
      },
      {
        type: "paragraph" as const,
        text: "Step 3 — Generate names. NamoLux checks domain availability in real time. Every name you see with a green checkmark is available to register today. The Founder Signal score tells you which names are strongest for long-term brand building.",
      },
      {
        type: "paragraph" as const,
        text: "Step 4 — Open Brand Studio. Once you have a name you like, click the Palette button on the result card. This takes you to Brand Studio with the name pre-filled.",
      },
      {
        type: "paragraph" as const,
        text: "Step 5 — Generate your colour palette. NamoLux builds a 5-colour identity: primary, secondary, accent, background, and text. Each colour comes with a hex code and a usage note. Click any swatch to copy the hex code.",
      },
      {
        type: "paragraph" as const,
        text: "Step 6 — Get your landing page. After the palette generates, a Stitch prompt appears at the bottom — pre-filled with your brand name, description, vibe, and all 5 colour codes. Copy it, open Google Stitch, paste, and generate.",
      },
      {
        type: "paragraph" as const,
        text: "Step 7 — Register your domain. If you haven't already, click the Register button on your chosen name. This takes you directly to Namecheap with the domain pre-filled.",
      },
      {
        type: "heading" as const,
        text: "Why This Changes the Game for Founders",
      },
      {
        type: "paragraph" as const,
        text: "The old way of building a brand identity required either significant budget (agency), significant time (DIY across 10 different tools), or significant compromise (generic results from disconnected tools).",
      },
      {
        type: "paragraph" as const,
        text: "The problem with most naming tools is that they stop at the name. They give you a list of options and leave you to figure out the rest. What domain? What colours? What does it actually look like? Those gaps are where founders get stuck and slow down.",
      },
      {
        type: "paragraph" as const,
        text: "NamoLux closes those gaps. The name comes with availability confirmed. The palette comes from the same brief as the name. The landing page prompt comes from the same palette. Everything connects because it was all built from the same starting point: your idea.",
      },
      {
        type: "heading" as const,
        text: "Conclusion: From Idea to Brand — In Seconds",
      },
      {
        type: "paragraph" as const,
        text: "This isn't just about generating names. It's about removing the friction between idea and brand.",
      },
      {
        type: "paragraph" as const,
        text: "Instead of spending hours trying to figure everything out separately, you can now generate a name, build a brand story, create a visual identity, and get a landing page — all in one flow.",
      },
      {
        type: "paragraph" as const,
        text: "Joynest. Authway. Finesh. Three completely different brands, three completely different industries, three completely different visual identities — all built in the same tool, in under five minutes each.",
      },
      {
        type: "paragraph" as const,
        text: "Your idea is next. From idea to brand — in seconds.",
      },
    ],
    faqs: [
      {
