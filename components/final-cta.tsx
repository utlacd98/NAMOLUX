...
const assurances = ["No account required", "Free shortlist scoring", "One-time £15 for Pro — no subscription"]
      ...
      <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        <Reveal>
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground">
            Paste your shortlist. Get Founder Signal™ scores, live availability across 6 TLDs, and a clear verdict on
            every candidate. Start free, no credit card required.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.15} className="mt-10">
          ...
          >
            ...
            <span className="relative">Score my shortlist free</span>
